...
default: help
help:
	@echo 'Management commands for ($(PKG))'
...
docker-rmi: ## Deleting previous build images.
ifneq ($(PREV_IMAGES),)
...
docker-log:  ## Showing container logs.
